...
const createIcon = (svgPaths) => {
  return ({ size = 20, color = "currentColor", className = "", style = {} }) => (
    <svg
...
export const Key = createIcon(
  <>
    <path d="m21 2-2 2m-1.5 1.5L14 9a5.5 5.5 0 1 0 1.5 1.5l3.5-3.5" />
...
export const Loader2 = ({ size = 20, color = "currentColor", className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Star = ({ size = 20, color = "currentColor", fill = "none", className = "", style = {} }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
